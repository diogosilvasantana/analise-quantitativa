...
export function IndicesPanel({ data }: IndicePanelProps) {
    ...
    return (
        <div className="w-full bg-slate-950 border-y border-slate-800 overflow-hidden relative h-10 flex items-center">
            ...
            <div className="flex animate-marquee whitespace-nowrap hover:pause-animation">
                {tickerItems.map((item, idx) => {
                    ...
                    const colorClass = isPositive ? 'text-emerald-400' : isNegative ? 'text-rose-500' : 'text-slate-400';
